...
奥地利邮政服务公司的[加密邮票](https://opensea.io/assets/cryptostamp)项目为购买官方实体邮票的人提供了一条进入数字收藏品世界的方便途径。每一枚实体邮票都有一个不透明的、可以刮掉的部分。在刮刮区下方，购买者会发现一个包含少量 ETH 的私钥和实体印章的数字副本，然后他们可以在 OpenSea 上出售这些私钥。
